...
--Needed objects for the mission
--
--Blue_CTLD_FOB (Is infantry)
--
--Blue_Airwing_Factory (Static usually techcombine)
--Blue_Brigade_Factory(Static usually techcombine)
--Red_CTLD_FOB (Is infantry)
--Red_Airwing_Factory(Static usually techcombine)
--Red_Brigade_Factory(Static usually techcombine)